...
- 当前最新版本（截至 2026-03-03）：[`v1.0.3`](https://github.com/izscc/x2md/releases/tag/v1.0.3)
- 下载对应平台包：
  - Mac: [`X2MD_Mac.zip`](https://github.com/izscc/x2md/releases/download/v1.0.3/X2MD_Mac.zip)
  - Windows: [`X2MD_Windows.zip`](https://github.com/izscc/x2md/releases/download/v1.0.3/X2MD_Windows.zip)
