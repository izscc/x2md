...
- 当前最新版本：[`v1.5.2`](https://github.com/izscc/x2md/releases/tag/v1.5.2)
- 下载对应平台包：
  - Mac: [`X2MD_Mac.zip`](https://github.com/izscc/x2md/releases/download/v1.5.2/X2MD_Mac.zip)
  - Windows: [`X2MD_Windows.zip`](https://github.com/izscc/x2md/releases/download/v1.5.2/X2MD_Windows.zip)
  - 扩展: [`X2MD_Extension.zip`](https://github.com/izscc/x2md/releases/download/v1.5.2/X2MD_Extension.zip)
...
- `enable_platform_folders`: 是否按平台分子文件夹（Twitter/、LINUX DO/、飞书/、微信公众号/）
